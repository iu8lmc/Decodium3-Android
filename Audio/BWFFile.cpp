  ...
  if (be)
    {
      ...
      fmt.byte_rate = qToBigEndian<quint32> (format.sampleRate () * format.channelCount () * format.bytesPerSample ());
  ...
  else
    {
      ...
      fmt.byte_rate = qToLittleEndian<quint32> (format.sampleRate () * format.channelCount () * format.bytesPerSample ());
