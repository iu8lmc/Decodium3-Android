      ...
      switch (column)
        ...
        case region_column:
          switch (role)
            ...
            case Qt::TextAlignmentRole:
              item = QVariant::fromValue(Qt::AlignHCenter | Qt::AlignVCenter);
              break;
            }
          break;
        ...
        case frequency_column:
          switch (role)
            ...
            case Qt::TextAlignmentRole:
              item = QVariant::fromValue(Qt::AlignRight | Qt::AlignVCenter);
              break;
            }
          break;
            ...
            switch (role)
              {
                ...
                case Qt::TextAlignmentRole:
                  item = QVariant::fromValue(Qt::AlignLeft | Qt::AlignVCenter);
                break;
              }
            break;
